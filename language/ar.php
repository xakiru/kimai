...
return [
    "countryCode" => "en-EN",
    "preferences" => "انقر على التفضيلات",
    "total" => "المجموع",
    "monatzeit" => "شهر",
    "heute" => "اليوم",
    "gestern" => "البارحة",
    ...
    "timelabel" => "وقت",
    "starttime" => "وقت البدء",
    "DateTimeNotInFuture" => "يجب أن لا يكون اليوم والوقت في المستقبل.",
    "durationlabel" => "المدة",
    "customer" => "عميل",
    "project" => "مشروع",
    "activity" => "نشاط",
    ...
    "activities" => "أنشطة",
    "admin" => "مشرف",
    "rowlimit" => "الحد الأقصى لصفوف",
    "breiteZeitspalte" => "عرض العمود الزمني",
    "breiteUhrspalte" => "عرض العمود الساعة",
    "breiteDatumspalte" => "عرض العمود التاريخ",
    "recommended" => "موصى",
    "submit" => "تأكيد",
    "cancel" => "إلغاء",
    "edit" => "تحرير", 
    "editNote" => "تحرير الملحوظة",
    "note" => "ملحوظة",
    "close" => "إغلاق",
    "construction" => "في طور الانشاء ...",
    "about" => "Kimai معلومات",
    "hours" => "ساعات",
    "mins" => "الدقائق",
    "secs" => "ثواني",
    "skin" => "شكل",
    "erase" => "حذف",
    "new_customer" => "اضف عميل",
    "new_project" => "اضف مشروع",
    "new_activity" => "اضف نشاط",
    "day_summary" => "ملخص الوقت",
    "plzChoose" => "يرجى تحديد",
    "recordAgain" => "سجل هذا التسجيل مرة أخرى",
    "comment" => "تعليق",
    "location" => "موقع",
    "trackingNumber" => "رقم التتبع",
    "cookiewarning" => "قم بتشغيل الكوكيز في قبل المتابعة.",
    "JSwarning" => "يجب تشغيل JavaScript.",
    "designation" => "وصف",
    "banned" => "حظر، الحساب مقفل",
    "tooManyLogins" => "هناك عدد كبير من عمليات تسجيل الدخول الخاطئة - تم تعليق المستخدم.",
    "accessDenied" => "تم الرفض!",
    "wrongPass" => "اسم المستخدم و / أو كلمة المرور خاطئة",
    "tryAgain" => "حاول مرة أخرى / هل نسيت كلمة المرور؟",
    "back" => "العودة إلى صفحة الدخول",
    "bye" => "الى اللقاء!",
    "login" => "تسجيل الدخول",
    "logout" => "الخروج",
    "loggedon" => "تسجيل الدخول كمستخدم:",
    "username" => "اسم المستخدم",
    "password" => "كلمة المرور",
    "newPassword" => "كلمة مرور جديدة",
    "retypePassword" => "أعد إدخال كلمة السر",
    "passwordsDontMatch" => "كلمات المرور التي أدخلتها غير متطابقة.",
    "passwordTooShort" => "تحتاج كلمة المرور إلى 5 أحرف على الأقل.",
    ...
    "updateNow" => "تحديث قاعدة البيانات الآن!",
    "stop" => "توقف!",
    "start" => "ابدأ!",
    "setTimeframe" => "ضبط الإطار الزمني",
    "now" => "الآن",
    "specify" => "حدد القائمة",
    "add" => "إضافة",
    "addNote" => "أضف ملاحظة",
